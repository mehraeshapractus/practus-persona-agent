...
<div class="page">
  ...
  <form method="POST" action="/generate" enctype="multipart/form-data"
    ...
    <div class="form-card">
      ...
      <div class="form-section">
        <div class="form-section-label">Source Material <span style="font-weight:400;text-transform:none;letter-spacing:0;color:#A1A1AA;font-size:10px;">— leave blank to auto-search</span></div>
        <div class="field">
          <label>Upload LinkedIn PDF <span style="font-weight:400;color:#A1A1AA;">(LinkedIn → More → Save to PDF)</span></label>
          <input type="file" name="linkedinPdf" accept=".pdf" style="width:100%;padding:7px 0;font-size:13px;color:#3F3F46;cursor:pointer;">
        </div>
        <div class="field" style="margin-top:0.5rem">
          <label>Or paste text</label>
          <textarea name="pastedMaterial"
            placeholder="Paste LinkedIn bio, posts, press quotes, interview excerpts — or leave blank and the agent will search the web automatically."></textarea>
          <p class="hint">Upload a LinkedIn PDF export or paste text. Leave both blank to auto-search the web.</p>
        </div>
      </div>

      <div class="form-footer">
        <button type="submit" id="submitBtn">Generate persona brief</button>
        <p id="loading">Analyzing &mdash; usually 30&ndash;60 seconds&hellip;</p>
      </div>
