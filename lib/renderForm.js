    ...
    <div class="form-card">
      ...
      <div class="form-section">
        ...
        <div class="field" style="margin-top:0.75rem;">
          <label>Send report to <span style="font-weight:400;color:#A1A1AA;">(email)</span></label>
          <input type="email" name="recipientEmail" placeholder="yashwin.pamecha@roibypractus.com">
        </div>
      </div>
